...
I[2][1] = new Array();
I[2][1][0] = new Array();
I[2][1][0][0] = '\u0073\u0063\u0061\u006E\u0066\u0028\u0022\u0025\u0064\u0022\u002C\u0020\u0026\u0061\u005B\u0078\u005D\u0029\u003B';
I[2][2]='';

I[3] = new Array();
I[3][1] = new Array();
I[3][1][0] = new Array();
I[3][1][0][0] = '\u0073\u0063\u0061\u006E\u0066\u0028\u0022\u0025\u0064\u0022\u002C\u0020\u0026\u0062\u005B\u0078\u005D\u0029\u003B';
I[3][2]='';

I[4] = new Array();
I[4][1] = new Array();
I[4][1][0] = new Array();
I[4][1][0][0] = '\u0070\u0072\u0069\u006E\u0074\u0066\u0020\u0028\u0022\u005C\u006E\u007C\u0025\u0064\u007C\u0022\u002C\u0020\u0073\u006F\u006D\u0061\u005B\u0078\u005D\u0029\u003B';
I[4][2]='';
...
<div class="Titles">
	<h2 class="ExerciseTitle">1) Complete o programa em C que consiste em criar dois vetores de cinco posi&#x00E7;&#x00F5;es cada um e armazenar a soma de seus elementos no vetor soma (tamb&#x00E9;m de 5 posi&#x00E7;&#x00F5;es).</h2>
...
<div class="ClozeBody">
#include <stdio.h><br />#include <stdlib.h><br />#include <conio.h><br /> main()<br />{<br /><span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="11"></input></span> <br /><span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="11"></input></span> <br />int soma [5];<br /> <br />printf ("\n escreva os elementos do vetor 1:\n");<br /> for (x=0; x&lt;5; x++)<br /> {<br /> <span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="19"></input></span> <br /> }<br /><br />printf ("\n\n escreva os elementos do vetor 2:\n");<br /><br />for (x=0; x&lt;5; x++)<br />{<br /> <span class="GapSpan" id="GapSpan3"><input type="text" id="Gap3" onfocus="TrackFocus(3)" onblur="LeaveGap()" class="GapBox" size="19"></input></span> <br />}<br /> <br /> for (x=0; x&lt;5; x++)<br /> { <br /> soma[x] = (a[x] + b[x]);<br /> }<br /><br />printf ("\n\n Vetor resultado");<br /> for (x=0; x&lt;5; x++)<br /> {<br /> <span class="GapSpan" id="GapSpan4"><input type="text" id="Gap4" onfocus="TrackFocus(4)" onblur="LeaveGap()" class="GapBox" size="27"></input></span> <br /> }<br /> <br /> getche();<br />
</div>
</form>
</div>
...
<a href="reflexivo_avancado_2.php"> Próximo </a>
</div>
