...
<div class="Titles">
	<h2 class="ExerciseTitle">10) Observando o programa a seguir complete:</h2>
...
<div class="ClozeBody">
#include <stdio.h><br />#include <conio.h><br />#include <string.h><br />#include <stdlib.h><br /><br /><br />main()<br />{ <br /><br /> int num=1, vlr=4, res=4;<br /> <br /> while (res&lt;=20)<br /> {<br /> res= num + vlr;<br /> vlr= vlr+3;<br /> num= num+5;<br /> <br /> <br /> <br /> } <br /><br />printf ( "\n res: %d", res);<br /> <br />printf ( "\n vlr: %d", vlr);<br />printf ( "\n num: %d", num); <br /> <br /> getche();<br /> <br /> <br />}<br />Res: <span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> <br />Valor: <span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> <br />Numero: <span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>
</div>
</form>
</div>
