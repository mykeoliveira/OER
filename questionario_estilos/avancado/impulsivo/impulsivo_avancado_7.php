...
<div class="Titles">
	<h2 class="ExerciseTitle">7) Observando o programa a seguir complete:</h2>
...
<div class="ClozeBody">
#include <stdio.h><br />#include <conio.h><br />main ()<br />{<br /> int i,j;<br /> <br /> i=10;<br /> <br /> j= i--;<br /> <br /> printf ("\nO valor de j eh: %d",j); <br /> printf ("\nO valor de i eh: %d",i); <br />valor de i: <span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> <br />valor de j:<span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>
</div>
</form>
</div>
...
<a href="impulsivo_avancado_8.php"> Próximo </a>
