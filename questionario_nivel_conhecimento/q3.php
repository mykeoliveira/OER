...
<div class="Titles">
	<h2 class="ExerciseTitle">3 - Associe a primeira coluna de acordo com a segunda.</h2>
...
<form id="QForm" method="post" action="q3_validar.php">
<table border="0" style="margin: 2em auto 2em auto;"><tbody id="Questions">

<tr><td class="LeftItem">if - else</td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="1">Permite que um determinado trecho do c&#x00F3;digo continue sendo executado de acordo com uma condi&#x00E7;&#x00E3;o.</option>
<option value="0">Decis&#x00E3;o, se n&#x00E3;o for uma op&#x00E7;&#x00E3;o &#x00E9; outra.</option>
<option value="2">Executar um comando at&#x00E9; que.</option>
</select></td><td></td></tr><tr><td class="LeftItem">while</td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="1">Permite que um determinado trecho do c&#x00F3;digo continue sendo executado de acordo com uma condi&#x00E7;&#x00E3;o.</option>
<option value="0">Decis&#x00E3;o, se n&#x00E3;o for uma op&#x00E7;&#x00E3;o &#x00E9; outra.</option>
<option value="2">Executar um comando at&#x00E9; que.</option>
</select></td><td></td></tr><tr><td class="LeftItem">for</td><td class="RightItem"><select id="s2_2"><option value="x"></option>
<option value="1">Permite que um determinado trecho do c&#x00F3;digo continue sendo executado de acordo com uma condi&#x00E7;&#x00E3;o.</option>
<option value="0">Decis&#x00E3;o, se n&#x00E3;o for uma op&#x00E7;&#x00E3;o &#x00E9; outra.</option>
<option value="2">Executar um comando at&#x00E9; que.</option>
</select></td><td></td></tr>
