...
var CorrectResponse = 'Parab&#x00E9;ns!';
var IncorrectResponse = 'Desculpe! Tente novamente';
...
<br><br />
	<h2 class="ExerciseTitle">7- Associe</h2>
...
<div id="InstructionsDiv" class="StdDiv">
	<div id="Instructions">Escolha a opção correta para cada uma das sentenças.</div>
</div>
...
<form id="QForm" method="post" action="q7_validar.php" >
<table border="0" style="margin: 2em auto 2em auto;"><tbody id="Questions">

<tr><td class="LeftItem">int</td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="0">Para armazenamento de qualquer n&#x00FA;mero inteiro, tanto negativo quanto nulo ou positivo.</option>
<option value="2">Armazena qualquer n&#x00FA;mero real, tanto negativo quanto nulo ou positivo.</option>
<option value="1">Usada para se armazenar quaisquer letras e n&#x00FA;meros.</option>
</select></td><td></td></tr><tr><td class="LeftItem">char</td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="0">Para armazenamento de qualquer n&#x00FA;mero inteiro, tanto negativo quanto nulo ou positivo.</option>
<option value="2">Armazena qualquer n&#x00FA;mero real, tanto negativo quanto nulo ou positivo.</option>
<option value="1">Usada para se armazenar quaisquer letras e n&#x00FA;meros.</option>
</select></td><td></td></tr><tr><td class="LeftItem">float</td><td class="RightItem"><select id="s2_2"><option value="x"></option>
<option value="0">Para armazenamento de qualquer n&#x00FA;mero inteiro, tanto negativo quanto nulo ou positivo.</option>
<option value="2">Armazena qualquer n&#x00FA;mero real, tanto negativo quanto nulo ou positivo.</option>
<option value="1">Usada para se armazenar quaisquer letras e n&#x00FA;meros.</option>
</select></td><td></td></tr>
