...
I[1][1] = new Array();
I[1][1][0] = new Array();
I[1][1][0][0] = '\u0070\u0072\u006F\u0067\u0072\u0061\u006D\u0061\u00E7\u00E3\u006F';
I[1][2]='';

I[2] = new Array();
I[2][1] = new Array();
I[2][1][0] = new Array();
I[2][1][0][0] = '\u0070\u0072\u006F\u0067\u0072\u0061\u006D\u0061\u0064\u006F\u0072\u0065\u0073';
I[2][2]='';
...
<?php echo "Olá, ". $numero . ". ATENÇÃO: É importante que você clique no botão 'verificar' antes de passar para a próxima questão, para que seja feita a avaliação e pontuação da questão.  ";
 //"Olá, " . $_SESSION['usuarioNome'] . "  (<a href='logout.php' style='text-decoration:none'>Sair</a>)";?>
<br />
<!-- BeginTopNavButtons -->

<!-- EndTopNavButtons --><br />
<div class="Titles">
<h2 class="ExerciseTitle">1- O que &#x00E9; a linguagem C?</h2>
...
<button class="FuncButton" onmouseover="FuncBtnOver(this)" onfocus="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)" onblur="FuncBtnOut(this)" onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" onclick="ShowHint()">&nbsp;Dica&nbsp;</button>
 ...
 <div id="ClozeDiv">
<form id="Cloze" method="post" action="q1_validar.php">
<div class="ClozeBody" align="justify">
C &#x00E9; uma <span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="9"></input></span> de <span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="11"></input></span> de computadores: Utilizada para criar c&#x00F3;digos com instru&#x00E7;&#x00F5;es para que o computador possa executar. Isso significa que voc&#x00EA; pode us&#x00E1;-la para criar listas de instru&#x00E7;&#x00F5;es para um computador seguir. A linguagem C &#x00E9; uma das milhares de linguagens de programa&#x00E7;&#x00E3;o atualmente em uso. Desenvolvida em 1972 por Dennis Ritchie no Bell Lab para uso no sistema operacional Unix, foi amplamente aceita por oferecer aos programadores o m&#x00E1;ximo em controle e efici&#x00EA;ncia. Existe h&#x00E1; v&#x00E1;rias d&#x00E9;cadas e ganhou ampla aceita&#x00E7;&#x00E3;o dos <span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="13"></input></span>.<br />
</div>
