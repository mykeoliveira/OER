...
I[1][1][0][0] = '\u0064\u0061\u0064\u006F';
I[1][1][1] = new Array();
I[1][1][1][0]='\u0069\u006E\u0066\u006F\u0072\u006D\u0061\u00E7\u00E3\u006F';
I[1][1][2] = new Array();
I[1][1][2][0]='\u0069\u006E\u0066\u006F\u0072\u006D\u0061\u0063\u0061\u006F';
I[1][1][3] = new Array();
I[1][1][3][0]='\u0076\u0061\u006C\u006F\u0072';
I[1][2]='';
...
<br><br />
	<h2 class="ExerciseTitle">5- Responda a seguinte pergunta</h2>

	<h3 class="ExerciseSubtitle">O que &#x00E9; uma vari&#x00E1;vel?</h3>
...
<div id="ClozeDiv">
<form id="Cloze" method="post" action="q5_validar.php" >
<div class="ClozeBody">
&#x00C9; um local na <span class="GapSpan" id="GapSpan0"><input type="text" id="Gap0" onfocus="TrackFocus(0)" onblur="LeaveGap()" class="GapBox" size="7"></input></span> capaz de armazenar um(a) <span class="GapSpan" id="GapSpan1"><input type="text" id="Gap1" onfocus="TrackFocus(1)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> representando um valor ou senten&#x00E7;a, que pode ser do tipo int, char, float, entre outros.
</div>
<br />
