...
<br><br />
	<h2 class="ExerciseTitle">6- Associe</h2>
...
<form id="QForm" method="post" action="q6_validar.php">
<table border="0" style="margin: 2em auto 2em auto;"><tbody id="Questions">

<tr><td class="LeftItem">Escrever</td><td class="RightItem"><select id="s0_0"><option value="x"></option>
<option value="1">Comando de sa&#x00ED;da que exibe uma informa&#x00E7;&#x00E3;o na tela do monitor.</option>
<option value="2">Comando de sa&#x00ED;da que envia uma informa&#x00E7;&#x00E3;o para a impressora.</option>
<option value="0">Comando de entrada que permite a leitura de vari&#x00E1;veis de entrada.</option>
</select></td><td></td></tr><tr><td class="LeftItem">Imprimir</td><td class="RightItem"><select id="s1_1"><option value="x"></option>
<option value="1">Comando de sa&#x00ED;da que exibe uma informa&#x00E7;&#x00E3;o na tela do monitor.</option>
<option value="2">Comando de sa&#x00ED;da que envia uma informa&#x00E7;&#x00E3;o para a impressora.</option>
<option value="0">Comando de entrada que permite a leitura de vari&#x00E1;veis de entrada.</option>
</select></td><td></td></tr><tr><td class="LeftItem">Ler</td><td class="RightItem"><select id="s2_2"><option value="x"></option>
<option value="1">Comando de sa&#x00ED;da que exibe uma informa&#x00E7;&#x00E3;o na tela do monitor.</option>
<option value="2">Comando de sa&#x00ED;da que envia uma informa&#x00E7;&#x00E3;o para a impressora.</option>
<option value="0">Comando de entrada que permite a leitura de vari&#x00E1;veis de entrada.</option>
</select></td><td></td></tr>
